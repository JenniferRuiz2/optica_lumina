        ...
        <div class="row">
            <section class="col">
                <div class="card border card-perfil-fondo">
                    ...
                    ?>
                    <img class="img-perfil-fondo border" src="<?php echo "data:image/jpg; base64,". base64_encode($array['foto']); ?>" alt="" />
                </div>
                <div class="card card-perfil border">
                    <div class="container">
                        <img class="img-perfil border" src="<?php echo "data:image/jpg; base64,". base64_encode($array['foto']); ?>" alt="" />
                        <div class="card-body">
                            <h6 class="card-title text-center"><?php echo $array["nombre"] ?></h6>
                            <p class="card-text text-center"> <?php echo $array["email"]; ?> <br>+52 <?php echo $array["telefono"]; ?></p>
                        </div>
                    </div>
                </div>
            </section>
